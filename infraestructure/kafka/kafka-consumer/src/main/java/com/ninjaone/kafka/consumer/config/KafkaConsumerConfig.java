package com.ninjaone.kafka.consumer.config;

import com.ninjaone.kafka.config.data.KafkaConfigData;
import com.ninjaone.kafka.config.data.KafkaConsumerConfigData;
